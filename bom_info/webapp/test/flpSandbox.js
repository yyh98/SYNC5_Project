		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BOM CRUD",
									"targetURL": "#cl3syncyoungppbombominfo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3syncyoungppbombominfo-display": {
								"semanticObject": "cl3syncyoungppbombominfo",
								"action": "display",
								"description": "BOM CRUD",
								"title": "BOM CRUD",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3.syncyoung.pp.bom.bominfo",
									"url": sap.ui.require.toUrl("cl3/syncyoung/pp/bom/bominfo")
								}
							}
						}
					}
